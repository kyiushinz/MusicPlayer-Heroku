...
async def play(client: Client, message_: Message):
    ...
    res = await message_.reply_text("🔄 Sedang memuat playing lagu...")
    ...
    if audio:
        ...
        if offset == None:
            await res.edit_text("❕ Kamu tidak memberikan saya Lagu/Song.")
            return
    ...
    if is_playing:
        ...
        await res.edit_text(f"#️⃣ Musik memasuki antrian.. {position}.")
    else:
        await res.edit_text("▶️ Mulai Music...")
